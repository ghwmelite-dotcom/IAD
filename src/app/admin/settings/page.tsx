...
const SETTINGS_CONFIG: SystemSetting[] = [
  ...
  },
  {
    ...
    description: 'Demo mode uses sample data stored locally. Live mode fetches real data from the IAD Pages Functions API.',
    icon: Server,
    gradient: 'from-green-500 to-emerald-600',
    category: 'Data Sources',
  },
  {
    key: 'iad_submission_notifications',
    label: 'Submission Notifications',
    description: 'When enabled, sends email/SMS notifications to citizens as their submissions change status.',
    icon: Globe,
