...
/**
 * Full public profile rendering for a verified IAC officer. Presentational
 * (no data fetching) — used by the prerendered /registry/[slug] pages and
 * the runtime /registry/profile fallback.
 */
